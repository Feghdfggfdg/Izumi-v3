...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~JxK3xSRp",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✪⏤͟͞★⃝ꪶ‎𝐂𝐊⊮𝐀𝐏𝐔𝐑𝐁𝐎𖥘✪͜͡➺",
  BOT_NAME: process.env.BOT_NAME || "✪⏤͟͞★⃝ꪶ‎𝐂𝐊⊮𝐀𝐏𝐔𝐑𝐁𝐎𖥘✪͜͡➺",
